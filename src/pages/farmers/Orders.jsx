...
export default function FarmerOrders() {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        setLoading(true);
        const data = await getFarmerOrders({ page: orderPage, limit: 6, status: orderStatus });
        setOrders(data.orders || []);
        setOrderTotalPages(data.totalPages || 1);
        setOrderPage(data.page || orderPage);
      } catch (err) {
      ...
      <div className="card p-3 mb-4 shadow-sm">
        <div className="row g-3 align-items-end">
          <div className="col-md-4">
            <label className="form-label small mb-1">Status filter</label>
            <select
            ...
            >
              ...
              <option value="awaiting_driver_accept">Awaiting Driver</option>
