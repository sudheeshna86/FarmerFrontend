      ...
      async (pos) => {
        ...
        try {
          ...
          if (data?.address) {
            ...
            alert("Location autofilled. Please verify before saving.");
          }
        } catch (err) {
                  ...
                  {showAddAddress && (
                    <div className="bg-light p-4 rounded mb-4 border">
                      ...
                      <form onSubmit={handleAddressSubmit}>
                        <div className="row g-3 mb-3">
                          <div className="col-12 mb-2 d-flex gap-2">
                            <button
                              type="button"
                      ...
                      <div className="d-flex justify-content-between">
                        <div>
                          <div className="d-flex align-items-center mb-2">
                            <span className="badge bg-light text-dark border text-uppercase me-2" style={{ fontSize: "10px" }}>
                              {addr.type}
                            </span>
